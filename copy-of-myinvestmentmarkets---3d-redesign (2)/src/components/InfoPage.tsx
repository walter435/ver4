...
// --- HELPER: Render Formatted Text (Handles Bold Subheadings and Lists) ---
const renderFormattedText = (text: string) => {
  ...
  return lines.map((line, index) => {
    ...
    // Handle Subheadings wrapped in **Text**
...
export const InfoPage: React.FC<InfoPageProps> = ({ content, t }) => {
